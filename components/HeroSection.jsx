  ...
  return (
    <section className="hero" id="home">
      <div className="container hero-container">
        ...
        {/* Left aligned content at the bottom */}
        <div className="hero-content" data-reveal>
          <h1 className="hero-title-mockup">
            Shaping Futures,<br />
            Inspiring Excellence
          </h1>
          <p className="hero-description-mockup">
            A place where knowledge meets opportunity and every student is empowered to achieve greatness.
          </p>
